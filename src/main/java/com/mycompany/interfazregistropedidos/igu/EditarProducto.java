...
public class EditarProducto extends javax.swing.JFrame implements Funcionamiento{
    ...
    public EditarProducto(String codigoProducto) {
        ...
        initComponents();
        this.cargarDatosEdicion(this.codigoProdAEditar);
    }
        ...
        jPanel1Layout.setHorizontalGroup(
            ...
            .addGroup(jPanel1Layout.createSequentialGroup()
                ...
                .addGroup(jPanel1Layout.createParallelGroup(javax.swing.GroupLayout.Alignment.LEADING)
                    ...
                    .addGroup(jPanel1Layout.createSequentialGroup()
                        .addComponent(btnGuardarCambios, javax.swing.GroupLayout.PREFERRED_SIZE, 303, javax.swing.GroupLayout.PREFERRED_SIZE)
                        .addGap(18, 18, 18)
                        .addGroup(jPanel1Layout.createParallelGroup(javax.swing.GroupLayout.Alignment.LEADING, false)
    ...
    private void btnGuardarCambiosActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_btnGuardarCambiosActionPerformed
        ...
        controladora.editarProducto(codigoProducto, nombre, descripcion, cantStock, precio);
    ...
    public void mostrarCartel() {
        ...
        JOptionPane optionPane = new JOptionPane("Se editó el producto " + this.txtNombre.getText() + " correctamente");//Cuerpo del mensaje 
    ...
    private void cargarDatosEdicion(String codigoProdAEditar) {
        ...
        this.txtCodProducto.setText(String.valueOf(productoAEditar.getCodigo()));
        this.txtCodProducto.setEditable(false);
        this.txtNombre.setText(productoAEditar.getNombre());
        this.txatDescripcion.setText(productoAEditar.getDescripcion());
        this.scrollCantStock.setValue(productoAEditar.getCantStock());
        this.txtPrecio.setText(String.valueOf(productoAEditar.getPrecio()));
