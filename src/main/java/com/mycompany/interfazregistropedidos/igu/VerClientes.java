...
public class VerClientes extends javax.swing.JFrame implements Cargable{

    ControladoraLogica controladora = null;
    private int PRIMERA_COLUMNA = 0; //Es la columna en la que estarán los ID de la tabla. En este caso, el DNI de cada Cliente.
    private int NOMBRE_COLUMNA = 1; //Es la columna en la que estará el nombre del CLiente.
    ...
    private void initComponents() {
        ...
        lblArmaPedido.setText("CLIENTES");
    ...
    private void btnEliminarActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_btnEliminarActionPerformed
        /*
        Debo asegurarme de 2 cosas:
        1) Que la tabla NO este vacía ---> tabla.getRowCount() > 0
        2) Que se haya seleccionado un elemento de la tabla ---> tablaClientes.getSelectedRow() != -1: -1 --> Indica que NO hay una fila seleccionada
        */
        
        //Lo haré con un IF, pero luego cuando añada excepciones debo hacerlo con un Try Catch
        ...
        if (tablaClientes.getRowCount() > 0) {
            ...
            if (tablaClientes.getSelectedRow() != -1) {                
                ...
                controladora.eliminarCliente(dniCliente);
                /*
                Explicación:
                dniCliente: Requiere de un N° entero. Como la BD convierte todos los numeros a String, debo parsear el DNI de String a int mediante Integer.parseInt().
                ...
                */
                this.mostrarMensaje("fue eliminado correctamente", nombreCliente, "Eliminación Exitosa");
                
                this.cargarTabla();//Muestro la tabla nuevamente, con los registros actualizados
            } else {
                this.mostrarMensajeError("Para eliminar un cliente, debe seleccionarlo","Eliminación Inválida");

            }
        } else {
            this.mostrarMensajeError("Para eliminar un cliente, la tabla NO puede estar vacía ","Eliminación Inválida");
        }
    ...
    */
    ...
    private void btnEditarActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_btnEditarActionPerformed
        if (tablaClientes.getRowCount() > 0) {
            ...
            if (tablaClientes.getSelectedRow() != -1) {                
                ...
                EditarCliente pantallaEditarCliente  = new EditarCliente(dniCliente);
    ...
    private void cargarTabla() {
        ...
        */
        ...
        String titulosColumnas[] = {"DNI", "Nombre", "Celular", "Email", "Dirección", "Localidad", "Provincia", "Condición IVA", "Cant Pedidos Realizados"};
        ...
        List<Cliente> listaClientes = controladora.buscarClientes();
        
        this.agregarElementos(modeloTabla, listaClientes);
    }

    /*
    Itero la lista para añadir cada elemento a la modeloTabla
    */
    private void agregarElementos(DefaultTableModel modeloTabla, List<Cliente> listaClientes) {
        ...
        if(listaClientes != null){
            for (Cliente cadaCliente : listaClientes) {
                ...
                Object[] cliente = {cadaCliente.getDni(), cadaCliente.getNombre(), cadaCliente.getCelular(), cadaCliente.getMail(), cadaCliente.getDireccion(), cadaCliente.getLocalidad(), cadaCliente.getProvincia(), cadaCliente.getCondicionIva(), cadaCliente.getPedidos().size()};
    ...
    private void mostrarMensaje(String mensaje, String nombreCliente, String titulo) {
        //Ventana que mostrará que el Pedido fue añadido correctamente
        JOptionPane optionPane = new JOptionPane(nombreCliente + " " + mensaje);//Cuerpo del mensaje 
