...
public class VerProductos extends javax.swing.JFrame implements Cargable{
    ...
    private void initComponents() {
        ...
        lblArmaPedido.setText("PRODUCTOS");
    ...
    private void btnEliminarActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_btnEliminarActionPerformed
        if (tablaProductos.getRowCount() > 0) {
            ...
            if (tablaProductos.getSelectedRow() != -1) {                
                ...
                */
                this.mostrarMensaje("fue eliminado correctamente", nombreProducto, "Eliminación Exitosa");
                
                this.cargarTabla();//Muestro la tabla nuevamente, con los registros actualizados
            } else {
                this.mostrarMensajeError("Para eliminar un proucto, debe seleccionarlo","Eliminación Inválida");

            }
        } else {
            this.mostrarMensajeError("Para eliminar un producto, la tabla NO puede estar vacía ","Eliminación Inválida");
        }
    ...
    */
    ...
    private void btnEditarActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_btnEditarActionPerformed
        if (tablaProductos.getRowCount() > 0) {
            ...
            if (tablaProductos.getSelectedRow() != -1) {                
                ...
                EditarProducto pantallaEditarProducto = new EditarProducto(codigoProducto);
                pantallaEditarProducto.setVisible(true);
                pantallaEditarProducto.setLocationRelativeTo(null);
                this.setVisible(false);
                
                this.cargarTabla();//Muestro la tabla nuevamente, con los registros actualizados
            } else {
                this.mostrarMensajeError("Para editar un producto, debe seleccionarlo","Edición Inválida");

            }
        } else {
            this.mostrarMensajeError("Para editar un producto, la tabla NO puede estar vacía ","Edición Inválida");
        }
    ...
    private void cargarTabla() {
        ...
        */
        ...
        String titulosColumnas[] = {"Código", "Nombre", "Descripción", "Cant Stock Disponible", "$ Precio por Unidad"};
        ...
        List<Producto> listaProductos = controladora.buscarProductos();
    ...
    */
    private void agregarElementos(DefaultTableModel modeloTabla, List<Producto> listaProductos) {
        ...
        if(listaProductos != null){
            for (Producto cadaProducto : listaProductos) {
                ...
                Object[] producto = {cadaProducto.getCodigo(), cadaProducto.getNombre(), cadaProducto.getDescripcion(), cadaProducto.getCantStock(), cadaProducto.getPrecio()};
    ...
    private void mostrarMensaje(String mensaje, String remito, String titulo) {
